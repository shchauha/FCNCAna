        ...
        for(unsigned int event = 0; event < tree->GetEntriesFast(); ++event) {
            ...
            auto z_cand = [](int id1, int id2, float mll) {
                return abs(id1) == abs(id2) and  // Same flavor
                    ...
                    fabs(mll - 91.2) < 15;     // Z-mass window
            };
            ...
            */
            ...
            if (hyp_class == 3 and nleps == 2 and met < 50 and lep1ccpt > 25 and lep2ccpt > 20 and abs(lep1id) == 11 and abs(lep1id) == 11 and fabs(m12-91.2) <15. ) fill_region("ssonz", weight);
